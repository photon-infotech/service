...
<form id="formUserAdd" class="form-horizontal customer_list">
	...
	<div class="content_adder">
		<div class="control-group" id="firstNameControl">
			<label class="control-label labelbold">
				<span class="mandatory">*</span>&nbsp;<s:text name='lbl.user.first.name'/>
			</label>
			<div class="controls">
				<input id="input01" class="input-xlarge" type="text" 
					name="firstname" value="<%= firstName %>" maxlength="30" title="30 Characters only">
				<span class="help-inline" id="firstNameError"></span>
			</div>
		</div>
		
		<div class="control-group" id="lastNameControl">
			<label class="control-label labelbold">
				<span class="mandatory">*</span>&nbsp;<s:text name='lbl.user.last.name'/>
			</label>
			<div class="controls">
				<input id="input01" class="input-xlarge" type="text" 
					name="lastname" value="<%= lastName %>" maxlength="30" title="30 Characters only">
		...
		<div class="control-group" id="loginidControl">
			<label class="control-label labelbold">
				<span class="mandatory">*</span>&nbsp;<s:text name='lbl.user.loginid'/>
			</label>
			<div class="controls">
				<input id="input01" class="input-xlarge" type="text" 
					name="loginid" value="<%= loginid %>" maxlength="30" title="30 Characters only">
		...
		<div class="control-group repoMndatory" id ="userpwdControl">
			<label class="control-label labelbold">
				<span class="mandatory">*</span>&nbsp;<s:text name='lbl.user.passwd'/>
			</label>
			<div class="controls">
				<input id="userPwd"  class="input-xlarge" 
					name="userPwd" type="password" value="" maxlength="30" title="30 Characters only">
		...
		<div class="control-group repoMndatory" id ="userretypepwdControl">
			<label class="control-label labelbold">
				<span class="mandatory">*</span>&nbsp;<s:text name='lbl.user.retype.passwd'/>
			</label>
			<div class="controls">
				<input id="userrePwd"  class="input-xlarge" 
					name="userrePwd" type="password" value="" maxlength="30" title="30 Characters only">
		...
		<div class="control-group" id ="mailControl">
			<label class="control-label labelbold">
				<span class="mandatory">*</span>&nbsp;<s:text name='lbl.user.email'/>
			</label>
			<div class="controls">
	...
	<div class="bottom_button">
		...
		<% } %>
		<input type="button" id="userCancel" class="btn btn-primary" value="<s:text name='lbl.btn.cancel'/>" 
			onclick="getUserList();" />
	</div>
	
	<!-- Hidden Fields -->
    <input type="hidden" name="fromPage" value="<%= StringUtils.isNotEmpty(fromPage) ? fromPage : "" %>"/>
    <input type="hidden" name="oldName" value="<%= loginid %>"/>
