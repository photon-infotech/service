<!DOCTYPE html>
<%@page import="com.photon.phresco.service.rest.api.LoginService"%>
<%@page import="java.util.Properties"%>
<%@page import="java.io.InputStream"%>
<html>
<%
	InputStream is = LoginService.class.getClassLoader().getResourceAsStream("swagger.properties");
	Properties properties = new Properties();
	properties.load(is);
	String baseUrl = properties.getProperty("documentation.services.basePath"); 
%>
<head>
    <title>Phresco Service Swagger UI</title>
	...
	$(function () {
	    ...
	    window.swaggerUi = new SwaggerUi({
                discoveryUrl: '<%= baseUrl + "/api-docs.json"%>',
                apiKey:"",
                dom_id:"swagger-ui-container",
                supportHeaderParams: true,
                headers: { "X-phr-requestfrom": "swagger" },
