...
public class VideoPageTest {
	...
	@Test
	 public void testAddingNewVideos()throws InterruptedException, IOException, Exception{
		try {
			
			System.out.println("---------testComponentsAddEmptyConfigurationTemplatePage()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		baseScreen.addingNewVideos(methodName);
	...
	@Test
	 public void testCancelNewVideos()throws InterruptedException, IOException, Exception{
		try {
			
			System.out.println("---------testComponentsAddEmptyConfigurationTemplatePage()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		baseScreen.CancelNewVideos(methodName);
	...
	@Test
	 public void testDeleteAddedVideos()throws InterruptedException, IOException, Exception{
		try {
			
			System.out.println("---------testComponentsAddEmptyConfigurationTemplatePage()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		baseScreen.deleteAddedVideo(methodName);
