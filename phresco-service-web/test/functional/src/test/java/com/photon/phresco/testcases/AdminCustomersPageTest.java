...
public class AdminCustomersPageTest {
 ...
 @Test
 public void testcreateValidCustomer()throws InterruptedException, IOException, Exception{
	try {

		System.out.println("---------testValidCustomer()-------------");
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
		/*baseScreen.validLoginAdminUI(methodName);*/
